...
import { ShoppingBag, History, LogOut, Trophy, KeyRound, Wallet } from 'lucide-react'
...
export default function Layout() {
  ...
  const navItems = [
    ...
    { path: '/reveal', name: 'Reveal Portal', icon: KeyRound },
    { path: '/history', name: 'Riwayat & Klaim', icon: History },
  ]
